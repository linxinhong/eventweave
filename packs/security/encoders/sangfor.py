...
@encoder("sangfor-af", content_type="text/plain")
class SangforAFEncoder(Encoder):
    """Encode events as Sangor NGFW key-value logs."""

    name = "sangfor-af"
    content_type = "text/plain"
    description = "Sangor NGFW key-value traffic log format."
    ...
    _fields: list[tuple[str, str]] = [
        ("sangfor_time", "time"),
        ("sangfor_devname", "devname"),
        ("sangfor_srcip", "srcip"),
        ("sangfor_dstip", "dstip"),
        ("sangfor_srcport", "srcport"),
        ("sangfor_dstport", "dstport"),
        ("sangfor_proto", "proto"),
        ("sangfor_action", "action"),
        ("sangfor_policy", "policy"),
        ("sangfor_app", "app"),
    ]
